...
describe("constituency", ()=>{
    describe("entity", ()=>{
        ...
        before(async ()=>{
            const result = readFileSync('./test/fixtures/constituency/constituency.id-4125.json');
    ...
    describe("list", ()=>{
        let response: any;
        before(async ()=>{
            const result = readFileSync('./test/fixtures/constituency/constituencies.json');
