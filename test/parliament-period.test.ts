...
describe("parliamentPeriod", ()=>{
    describe("entity", ()=>{
        ...
        before(async ()=>{
            const result = readFileSync('./test/fixtures/parliament-periods/parliament-periods.id-111.json');
    ...
    describe("entity with ?show information", ()=>{ 
        let response: ParliamentPeriodResult;
        before(async ()=>{
            const result = readFileSync('./test/fixtures/parliament-periods/parliament-periods.id-111.show_information.json');
    ...
    describe("list", ()=>{
        let response: any;
        before(async ()=>{
            const result = readFileSync('./test/fixtures/parliament-periods/parliament-periods.json');
