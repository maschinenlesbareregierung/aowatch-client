...
describe("committee", ()=>{
    describe("entity", ()=>{
        ...
        before(async ()=>{
            const result = readFileSync('./__test__/fixtures/committee/committee.id-518.json');
    ...
    describe("entity with ?show information", ()=>{ 
        let response: CommitteeResult;
        before(async ()=>{
            const result = readFileSync('./__test__/fixtures/committee/committee.id-518.show_information.json');
    ...
    describe("list", ()=>{
        let response: any;
        before(async ()=>{
            const result = readFileSync('./__test__/fixtures/committee/committees.json');
