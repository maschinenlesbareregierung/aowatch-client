...
describe("electoral-list", ()=>{
    describe("entity", ()=>{
        ...
        before(async ()=>{
            const result = readFileSync('./__test__/fixtures/electoral-list/electoral-list.id-108.json');
    ...
    describe("list", ()=>{
        let response: any;
        before(async ()=>{
            const result = readFileSync('./__test__/fixtures/electoral-list/electoral-lists.json');
