...
describe("candidacy-mandate", ()=>{
    describe("entity", ()=>{
        ...
        before(async ()=>{
            const result = readFileSync('./__test__/fixtures/candidacy-mandate/candidacy-mandate.id-5.json');
    ...
    describe("entity with ?show information", ()=>{ 
        let response: CandidacyMandateResult;
        before(async ()=>{
            const result = readFileSync('./__test__/fixtures/candidacy-mandate/candidacy-mandate.id-38659.show_information.json');
