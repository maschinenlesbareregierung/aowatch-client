...
describe("poll", ()=>{
    describe("entity", ()=>{
        ...
        before(async ()=>{
            const result = readFileSync('./__test__/fixtures/poll/poll.id-3602.json');
    ...
    describe("list", ()=>{
        let response: any;
        before(async ()=>{
            const result = readFileSync('./__test__/fixtures/poll/polls.json');
    ...
    describe("entity with ?show information", ()=>{ 
        let response: PollResult;
        before(async ()=>{
            const result = readFileSync('./__test__/fixtures/poll/poll.id-3602.show_information.json');
