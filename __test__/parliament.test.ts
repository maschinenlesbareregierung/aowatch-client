...
describe("parliament", ()=>{
    describe("entity", ()=>{
        ...
        before(async ()=>{
            const result = readFileSync('./__test__/fixtures/parliament/parliament.id-5.json');
    ...
    describe("entity with ?show information", ()=>{ 
        let response: ParliamentResult;
        before(async ()=>{
            const result = readFileSync('./__test__/fixtures/parliament/parliament.id-5.show_information.json');
    ...
    describe("list", ()=>{
        let response: any;
        before(async ()=>{
            const result = readFileSync('./__test__/fixtures/parliament/parliament.json');
    ...
    describe("list range", ()=>{
        let response: any;
        before(async ()=>{
            const result = readFileSync('./__test__/fixtures/parliament/parliament-range.json');
    ...
    describe("list sorted", ()=>{
        let response: any;
        before(async ()=>{
            const result = readFileSync('./__test__/fixtures/parliament/parliament-sorted.json');
    ...
    describe("list filtered", ()=>{
        let response: any;
        before(async ()=>{
            const result = readFileSync('./__test__/fixtures/parliament/parliament-filtered.json');
    ...
    describe("list operator filtered", ()=>{
        let response: any;
        before(async ()=>{
            const result = readFileSync('./__test__/fixtures/parliament/parliament-filtered-operator.json');
    ...
    describe("list paged", ()=>{
        let response: any;
        before(async ()=>{
            const result = readFileSync('./__test__/fixtures/parliament/parliament-paged.json');
