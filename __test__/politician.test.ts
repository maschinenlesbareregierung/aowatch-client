...
describe("parliament", ()=>{
    describe("entity", ()=>{
        ...
        before(async ()=>{
            const result = readFileSync('./__test__/fixtures/politician/politicians.id-79137.json');
    ...
    describe("entity with ?show information", ()=>{ 
        let response: PoliticianResult;
        before(async ()=>{
            const result = readFileSync('./__test__/fixtures/politician/politicians.id-79137.show_information.json');
    ...
    describe("list", ()=>{
        let response: any;
        before(async ()=>{
            const result = readFileSync('./__test__/fixtures/politician/politicians.json');
