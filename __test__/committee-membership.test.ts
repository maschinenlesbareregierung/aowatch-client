...
describe("committee-membership", ()=>{
    describe("entity", ()=>{
        ...
        before(async ()=>{
            const result = readFileSync('./__test__/fixtures/committee-membership/committee-membership.id-3542.json');
        ...
        describe("list", ()=>{
            let response: any;
            before(async ()=>{
                const result = readFileSync('./__test__/fixtures/committee-membership/committee-memberships.json');
