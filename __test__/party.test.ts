...
describe("party", ()=>{
    describe("entity", ()=>{
        ...
        before(async ()=>{
            const result = readFileSync('./__test__/fixtures/party/party.id-2.json');
    ...
    describe("entity with ?show information", ()=>{ 
        let response: PartyResult;
        before(async ()=>{
            const result = readFileSync('./__test__/fixtures/party/party.id-2.show_information.json');
    ...
    describe("list", ()=>{
        let response: any;
        before(async ()=>{
            const result = readFileSync('./__test__/fixtures/party/parties.json');
